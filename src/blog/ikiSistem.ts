export const ikiSistem = `
# İki Sistem, Bir Karar: Düşüncelerin Kontrolü Kimde?
...
Bir kişi, arkadaşının “umursamaz” biri olduğuna inanıyorsa, geç gelen bir mesaja hemen bu inançla anlam yükleyebilir: “Bak yine önemsemiyor.”
Oysa hızlı ve içten mesajları fark etmez ya da sıradan sayar. Yani, zihni, mevcut beklentiyi doğrulayan sinyalleri seçici şekilde algılar.

## Düşünen ve Kontrol Eden Zihin: Sistem 2
...
### Dikkatin Sınırları ve Odaklanma

Zihnimiz aynı anda binlerce uyarana maruz kalır ama bunların hepsine odaklanamayız. Zihinsel kaynakların belirli bir bilgiyi işlemek üzere yöneltilmesini açıklamak için çeşitli dikkat teorileri geliştirilmiştir. **Seçici Dikkat Teorisi** (_Selective Attention Theory_), zihnin yalnızca belirli bilgiye odaklandığını ve diğer uyaranları filtrelediğini öne sürer. Bu filtreleme süreci, **Dikkat Darboğazı** (_Attentional Bottleneck_) olarak bilinir.

Bunun temel nedeni, beynin enerji ve kaynaklarını verimli kullanma ihtiyacı. Zihnimiz, sürekli olarak maruz kaldığımız devasa miktarda bilgiyi işlemek zorunda. Eğer her detaya eşit dikkat harcasaydık, zihinsel olarak çok çabuk tükenirdik. Bu yüzden, beyin enerjisini ve dikkatini en önemli gördüğü şeylere yönlendirir ve tekrarlayan, rutin unsurları arka plana atar.
...
Sistem 2 bu önerileri onaylarsa;

- izlenimler ve sezgiler inançlara dönüşür,
- dürtüler de bilinçli eylemlere dönüşür.

Her şey yolunda gittiğinde—ki çoğu zaman böyledir—**Sistem 2, Sistem 1’in önerilerini fazla değiştirmeden kabul eder.**
Genelde izlenimlerinize inanır ve arzularınıza göre davranırsınız—ve bu genellikle işe yarar.

Ancak **Sistem 1 zorlandığında**,
anlık problemi çözmek için daha ayrıntılı ve özel bir işlem süreci gerekir ve **Sistem 2 devreye girer.**

Örneğin:
19 × 56 işlemini görünce, Sistem 1’in doğrudan cevabı olmayabilir—böylece Sistem 2 devreye girer.
Benzer şekilde, **beklenmedik bir durumla karşılaştığınızda**, bilincinizde bir dikkat yükselmesi hissedersiniz.
Sistem 2, Sistem 1’in dünya modeliyle uyuşmayan bir olay algılandığında harekete geçer.

Çünkü Sistem 1, yaptığı işte genellikle iyidir, tanıdık durumlar için modelleri isabetlidir ancak mantık ve istatistik anlayışı zayıftır.
