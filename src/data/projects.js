...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Servis Plan offers comprehensive vehicle management for individual car owners, combining 30 years of fleet expertise into a single digital platform. From repairs, maintenance, and roadside assistance to exclusive discounts and real-time support, we deliver seamless service through one contact point — anytime, anywhere.",
    code: "",
    tags: [
      "React Native",
      "Firebase Cloud Messaging",
